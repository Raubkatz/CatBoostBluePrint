...
plt.title("Averaged Confusion Matrix (Undersampled)", fontsize=20)
...
plt.title("Relative Confusion Matrix (Undersampled, Normalized)", fontsize=20)
plt.xlabel("Predicted Labels", fontsize=18)
plt.ylabel("True Labels", fontsize=18)
plt.xticks(fontsize=18)
plt.yticks(fontsize=18)
...
plt.title("Feature Importance Analysis (Relative)", fontsize=20)
